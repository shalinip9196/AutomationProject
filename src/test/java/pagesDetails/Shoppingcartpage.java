	...
	driver.findElement(By.id("signInSubmit")).click();
		 ...
		 //wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_email")));
			 ...
			 driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(40));
			  ...
			  //click on product
			 driver.get("https://www.amazon.ca/JETech-iPhone-6-1-Inch-Shockproof-Anti-Scratch/dp/B07QS4NMW6/ref=sr_1_1_sspa?crid=WBC2D3X64YW0&keywords=iphone+12+case&qid=1698873167&sprefix=iphone+12+case%2Caps%2C209&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1");
...
//			  //click on cart
		  ...
		  driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(20));
			...
			//Assert.assertEquals(pricedetails.getText(), "$12.99");
			 ...
			 driver.get("https://www.amazon.ca/Polyte-Professional-Quick-Microfiber-Drying/dp/B07NVWR2R7/ref=sr_1_1_sspa?crid=2L58G9VSYB6IM&keywords=towles+large&qid=1698878484&sprefix=towles+large%2Caps%2C231&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1");
			 ...
			 ac.moveToElement(driver.findElement(By.id("submit.add-to-cart-announce"))).click().build().perform();
			  ...
			  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"sw-atc-details-single-container\"]")));
			  driver.findElement(By.id("twotabsearchtextbox")).sendKeys("note");
			  driver.findElement(By.id("nav-search-submit-button")).click();
			driver.get("https://www.amazon.ca/AmazonBasics-Writing-Narrow-Orchid-6-Pack/dp/B07TQ8567K/ref=sr_1_1_ffob_sspa?crid=3GT96THI13LBW&keywords=note&qid=1698883890&sprefix=note%2Caps%2C293&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1");
			 driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(20));
			ac.moveToElement(driver.findElement(By.id("submit.add-to-cart"))).click().build().perform();
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"sw-atc-details-single-container\"]")));
			 ...
			 WebElement towelprice=driver.findElement(By.id("sc-subtotal-amount-buybox"));
			  ...
			  //remove all items
			  driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(20));
			  WebElement deletebtm=driver.findElement(By.cssSelector("span.a-size-small:nth-child(3) > span:nth-child(1) > input:nth-child(1)"));
			 deletebtm.click();
			 ...
			 WebElement deletebtm1=driver.findElement(By.xpath("//*[@id=\"sc-active-921af05e-16a6-4be4-ada9-f1f7f254c9e6\"]/div[4]/div/div[3]/div[1]/span[2]"));
				 deletebtm1.click();
